...
(function () {
    ...
    UsuariosController.$inject = ['$timeout', '$location', '$q', 'LoginDataService', 'UsuariosDataService', 'EventosDataService'];

    function UsuariosController($timeout, $location, $q, LoginDataService, UsuariosDataService, EventosDataService) {
        var vm = this;
        /* Propiedades */
        ...
        function activate() {
            ...
            UsuariosDataService.getUsuarios()
        ...
        function clickGrabar() {
            if (vm.validar()) {
                ...
                if (vm.idUsuario !== '') {
                    UsuariosDataService.putUsuario(vm.usuario)
					.then(grabarUsuarioComplete);
                }
                else {
                    UsuariosDataService.postUsuario(vm.usuario)
					.then(grabarUsuarioComplete);
                }
            }
            else {
        ...
        function clickConfirmaBorrar() {
            UsuariosDataService.deleteUsuarios(vm.idUsuario)

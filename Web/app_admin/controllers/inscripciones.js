...
(function () {
	'use strict';
	angular.module('eventos.inscripciones', [])
		.controller('Inscripciones', ['$timeout', '$location', 'dataservice', 'logger', Inscripciones]);

	function Inscripciones($timeout, $location, dataservice, logger) {
		var vm = this;
		/* Propiedades */
